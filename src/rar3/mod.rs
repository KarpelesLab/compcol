//! RAR 3.x (2002-2013) — PPMd-II + custom LZ77/Huffman + filters — decoder-only stub.
//!
//! Reference: <https://github.com/libarchive/libarchive/blob/master/libarchive/archive_read_support_format_rar.c>.
//!
